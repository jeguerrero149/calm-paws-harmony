...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-20">
      ...
      <div className="absolute bottom-20 left-20 w-28 h-28 bg-pelambre-bittersweet border-4 border-black -rotate-12 animate-float opacity-80" style={{ borderRadius: '30% 70% 70% 30% / 30% 30% 70% 70%' }} />
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className={cn(
            ...
            <h1 className="font-display text-6xl md:text-7xl lg:text-8xl uppercase leading-tight tracking-tight">
              <span className="inline-block rotate-2 text-pelambre-bittersweet drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]" style={{ textShadow: '3px 3px 0 rgba(0,0,0,0.2)' }}>Snacks</span>{' '}
              <span className="inline-block -rotate-1 text-pelambre-violet font-black drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]" style={{ textShadow: '3px 3px 0 rgba(0,0,0,0.2)' }}>Para</span>{' '}
              <span className="inline-block rotate-1 text-pelambre-lemon font-black drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]" style={{ textShadow: '3px 3px 0 rgba(0,0,0,0.2)' }}>Perros</span>{' '}
              <span className="inline-block -rotate-2 text-pelambre-magenta font-black drop-shadow-[0_4px_12px_rgba(0,0,0,0.3)]" style={{ textShadow: '3px 3px 0 rgba(0,0,0,0.2)' }}>Cool</span>
            </h1>

            {/* Description */}
            <p className={cn(
              "font-sans text-xl md:text-2xl text-foreground/90 max-w-lg font-semibold transition-all duration-1000 delay-200",
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            )}>
              Productos naturales que ayudan a tu perro a relajarse con estilo. ¡Dale el mejor regalo a tu mejor amigo!
            </p>

            {/* CTA Buttons */}
            <div className={cn(
              "flex flex-wrap gap-4 transition-all duration-1000 delay-300",
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            )}>
              <Link
                to="/products"
                className="group pelambre-border bg-accent text-accent-foreground px-8 py-4 font-display text-2xl uppercase inline-flex items-center gap-3 transition-all duration-300 hover:rotate-2 hover:scale-105 hover:shadow-2xl active:scale-95 active:rotate-0"
              >
                Comprar Ahora
              ...
              <Link
                to="/about"
                className="pelambre-border-thin bg-card text-card-foreground px-8 py-4 font-display text-2xl uppercase inline-flex items-center gap-3 transition-all duration-300 hover:-rotate-2 hover:scale-105 hover:shadow-xl active:scale-95 active:rotate-0"
              >
                Conocer Más
              </Link>
            </div>
            ...
            {/* Benefits Grid */}
            <div className={cn(
              "grid grid-cols-3 gap-4 pt-8 transition-all duration-1000 delay-500",
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            )}>
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div 
                    key={index}
                    className={cn(
                      "pelambre-border-thin bg-secondary text-secondary-foreground p-4 text-center transition-all duration-300 hover:rotate-3 hover:scale-110",
                      index === 0 && "rotate-1",
                      index === 1 && "-rotate-1",
                      index === 2 && "rotate-2"
                    )}
            ...
            <div className="relative">
              ...
              <div className="pelambre-border bg-card p-4 rotate-3 hover:rotate-0 transition-all duration-500 hover:scale-105">
                <div className="aspect-square rounded-2xl overflow-hidden">
                  <img
                    src={isotipo}
                    alt="Pelambre - Snacks para Perros"
