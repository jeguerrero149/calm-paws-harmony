...
const Hero = () => {
  ...
  return (
    <section className="pt-28 md:pt-36 pb-20 md:pb-32 overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute -bottom-[20%] right-[5%] w-[60%] h-[70%] bg-calmpets-magenta/30 rounded-full blur-[120px] animate-pulse-gentle" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute top-[40%] left-[30%] w-[35%] h-[40%] bg-calmpets-cyan/20 rounded-full blur-[80px] animate-pulse-gentle" style={{animationDelay: '1s'}}></div>
        
        {/* More dynamic decorative elements */}
        <div className="absolute top-[20%] right-[20%] w-12 h-12 bg-calmpets-cyan/40 rounded-full blur-sm animate-float" style={{animationDelay: '0.5s'}}></div>
        <div className="absolute bottom-[30%] left-[15%] w-10 h-10 bg-calmpets-magenta/40 rounded-full blur-sm animate-float" style={{animationDelay: '1.2s'}}></div>
        <div className="absolute top-[60%] right-[30%] w-16 h-16 bg-calmpets-cyan/30 rounded-full blur-md animate-float" style={{animationDelay: '2s'}}></div>
        ...
        <div className="absolute bottom-[25%] right-[20%] w-24 h-2 bg-calmpets-magenta/40 rounded-full transform -rotate-45 animate-float" style={{animationDelay: '1.8s'}}></div>
        <div className="absolute top-[45%] right-[10%] w-28 h-2 bg-calmpets-cyan/30 rounded-full transform rotate-[30deg] animate-float" style={{animationDelay: '0.7s'}}></div>
        ...
        <div className="absolute bottom-[15%] right-[40%] w-32 h-32 bg-white/5 dark:bg-white/10 backdrop-blur-md transform -rotate-12 animate-rotate-slow" style={{animationDelay: '2.5s'}}></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={cn(
              "flex flex-col space-y-8 text-center lg:text-left transition-opacity duration-700",
              ...
              <div className="flex justify-center lg:justify-start">
                <div className="flex items-center gap-2 bg-gradient-to-r from-calmpets-cyan/30 to-calmpets-magenta/30 backdrop-blur-md px-6 py-2 rounded-full text-sm font-bold tracking-wide transform -skew-x-6 animate-pulse-gentle relative overflow-hidden group">
                  ...
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-calmpets-cyan to-calmpets-magenta relative z-10 uppercase letter-spacing-wide">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-xl max-w-xl mx-auto lg:mx-0 animate-reveal-up transform skew-x-3" style={{animationDelay: '100ms'}}>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start pt-4 animate-reveal-up" style={{animationDelay: '200ms'}}>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 pt-6 animate-reveal-up" style={{animationDelay: '300ms'}}>
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex flex-col items-center lg:items-start gap-3 transform transition-all duration-500 hover:scale-110 hover:rotate-3">
            ...
            <div className={cn(
              "relative transition-opacity duration-1000 transform skew-y-3 -rotate-3",
              isLoaded ? "opacity-100" : "opacity-0"
            )}>
              ...
              <div className="absolute bottom-[10%] -left-16 w-32 h-32 bg-calmpets-magenta/40 rounded-full blur-md animate-float" style={{animationDelay: '1s'}}></div>
              <div className="absolute top-[30%] left-[10%] w-24 h-24 bg-calmpets-cyan/30 rounded-full blur-sm animate-float" style={{animationDelay: '2s'}}></div>
              <div className="absolute bottom-[30%] right-[15%] w-20 h-20 bg-calmpets-magenta/30 rounded-full blur-sm animate-float" style={{animationDelay: '1.5s'}}></div>
